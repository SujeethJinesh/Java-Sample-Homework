...
public class Position {
     ...
     * @param xInput new x position of the cell
     */
    public void setX(int xInput) {
        this.x = xInput;
        rectangle.setX(xInput * SnaekFX.CELL_SIZE + 1);
    }

    /**
     * Setter method for the Y position of the cell
     * @param yInput new y position of the cell
     */
    public void setY(int yInput) {
        this.y = yInput;
        rectangle.setY(yInput * SnaekFX.CELL_SIZE + 1);
    }
